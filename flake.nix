{
  ...
  outputs = {nixpkgs, ...}: let
    ...
    prebuilt = pkgs.stdenvNoCC.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url = "https://github.com/MathieuMoalic/mont/releases/download/v0.8.2/mont-v0.8.2-x86_64-linux.tar.gz";
        hash = "sha256-vbVxWb0Dg6VwI/ZZzDsqYZFvlgcHnOs5t8MHAUctz7E=";
      };
      ...
      installPhase = ''
        install -Dm755 mont-v0.8.2-x86_64-linux $out/bin/mont
        patchelf \
